"""Relation service seed for journal_entry."""
...
RELATED_DOCS = [{'doc_id': 'general_ledger_account', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'ledger_posting', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'supplier_invoice', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'customer_invoice', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'supplier_payment', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'receipt_record', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'account names'}, {'description': 'types from general_ledger_account'}, {'description': 'source references from upstream payable or receivable docs'}]
