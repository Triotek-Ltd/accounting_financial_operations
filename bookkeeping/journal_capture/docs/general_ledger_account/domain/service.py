"""Business-domain service seed for General Ledger Account."""

from __future__ import annotations


ARCHETYPE_PROFILE = {'workflow_profile': {'mode': 'entity_lifecycle', 'case_management': False}, 'reporting_profile': {'supports_snapshots': False, 'supports_outputs': False}, 'integration_profile': {'external_sync_enabled': False}, 'lifecycle_states': ['active', 'disabled', 'archived'], 'is_transactional': False}

CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'currency': 'currency_code', 'active_status': 'status_flag', 'related_journal_entry': 'relation_collection', 'related_ledger_posting': 'relation_collection', 'related_cost_center': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'account_code', 'account_name', 'account_type'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'active', 'lifecycle_states': ['active', 'disabled', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'create': None, 'update': None, 'review': None, 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': ['postings feed reporting, reconciliation, receivables, payables, and closing workflows'], 'related_docs': ['journal_entry', 'ledger_posting', 'cost_center'], 'action_targets': {'create': None, 'update': None, 'review': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
