"""Relation service seed for general_ledger_account."""
...
RELATED_DOCS = [{'doc_id': 'journal_entry', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'ledger_posting', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'cost_center', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []
