"""Relation service seed for closing_batch."""
...
RELATED_DOCS = [{'doc_id': 'reporting_period', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'adjustment_entry', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'financial_statement_run', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'reporting-period dates from reporting_period'}]
