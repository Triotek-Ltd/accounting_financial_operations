"""Relation service seed for statement_line."""
...
RELATED_DOCS = [{'doc_id': 'financial_statement_run', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'general_ledger_account', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'statement identity from financial_statement_run'}, {'description': 'mapped account groups from general_ledger_account'}]
