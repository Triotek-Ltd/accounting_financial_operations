"""Action handler seed for financial_statement_run:publish."""
...
ACTION_ID = "publish"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['draft', 'generated', 'reviewed', 'approved', 'published'], 'transitions_to': 'published'}
