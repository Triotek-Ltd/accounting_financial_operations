"""Action handler seed for financial_statement_run:generate."""
...
ACTION_ID = "generate"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['draft', 'generated', 'reviewed', 'approved', 'published'], 'transitions_to': None}
...
def handle_generate(payload: dict, context: dict | None = None) -> dict:
    context = context or {}
