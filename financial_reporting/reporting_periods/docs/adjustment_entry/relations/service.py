"""Relation service seed for adjustment_entry."""
...
RELATED_DOCS = [{'doc_id': 'reporting_period', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'journal_entry', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'closing_batch', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'period boundaries from reporting_period'}]
