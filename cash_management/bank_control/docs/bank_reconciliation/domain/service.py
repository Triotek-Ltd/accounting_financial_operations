"""Business-domain service seed for Bank Reconciliation."""

from __future__ import annotations


ARCHETYPE_PROFILE = {'workflow_profile': {'mode': 'case_flow', 'supports_assignment': True, 'supports_escalation': True}, 'reporting_profile': {'supports_snapshots': True, 'supports_outputs': False}, 'integration_profile': {'external_sync_enabled': False}, 'lifecycle_states': ['open', 'matching', 'balanced', 'approved', 'closed', 'archived'], 'is_transactional': False}

CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'closing_balance': 'monetary_value', 'reconciliation_status': 'status_flag', 'related_cash_account': 'relation_collection', 'related_receipt_record': 'relation_collection', 'related_supplier_payment': 'relation_collection', 'related_journal_entry': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'reconciliation_code', 'bank_account', 'statement_period'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'open', 'lifecycle_states': ['open', 'matching', 'balanced', 'approved', 'closed', 'archived'], 'terminal_states': ['closed', 'archived'], 'action_targets': {'create': None, 'match': None, 'review': None, 'approve': 'approved', 'close': 'closed', 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['cash_account', 'receipt_record', 'supplier_payment', 'journal_entry'], 'action_targets': {'create': None, 'match': None, 'review': None, 'approve': 'approved', 'close': 'closed', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
