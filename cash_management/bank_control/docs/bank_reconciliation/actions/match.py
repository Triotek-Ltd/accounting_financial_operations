"""Action handler seed for bank_reconciliation:match."""
...
ACTION_ID = "match"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['open', 'matching', 'balanced', 'approved'], 'transitions_to': None}
...
def handle_match(payload: dict, context: dict | None = None) -> dict:
    context = context or {}
