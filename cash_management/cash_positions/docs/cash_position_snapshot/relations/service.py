"""Relation service seed for cash_position_snapshot."""
...
RELATED_DOCS = [{'doc_id': 'cash_account', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'bank_reconciliation', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'treasury_movement', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'account identity from cash_account'}]
