"""Business-domain service seed for Cash Account."""
...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'currency': 'currency_code', 'active_status': 'status_flag', 'related_receipt_record': 'relation_collection', 'related_supplier_payment': 'relation_collection', 'related_bank_reconciliation': 'relation_collection', 'related_treasury_movement': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'account_code', 'account_name', 'account_type'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'active', 'lifecycle_states': ['active', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'create': None, 'update': None, 'review': None, 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['receipt_record', 'supplier_payment', 'bank_reconciliation', 'treasury_movement'], 'action_targets': {'create': None, 'update': None, 'review': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
