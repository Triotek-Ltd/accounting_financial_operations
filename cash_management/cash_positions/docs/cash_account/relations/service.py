"""Relation service seed for cash_account."""
...
DOC_ID = "cash_account"
RELATED_DOCS = [{'doc_id': 'receipt_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'supplier_payment', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'bank_reconciliation', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'treasury_movement', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'institution metadata from bank integration docs where applicable'}]
