"""Business-domain service seed for Customer Invoice."""

from __future__ import annotations


ARCHETYPE_PROFILE = {'workflow_profile': {'mode': 'transaction_flow', 'supports_submission': True}, 'reporting_profile': {'supports_snapshots': True, 'supports_outputs': True}, 'integration_profile': {'external_sync_enabled': True, 'tracks_external_refs': True}, 'lifecycle_states': ['draft', 'approved', 'unpaid', 'partially_paid', 'paid', 'archived'], 'is_transactional': True}

CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state', 'transaction_date'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'transaction_date': 'transaction_date', 'party': 'primary_party', 'currency': 'currency_code', 'total_amount': 'total_amount', 'invoice_number': 'reference', 'customer': 'party_reference', 'invoice_date': 'schedule_marker', 'due_date': 'schedule_marker', 'taxes': 'structured_payload', 'totals': 'structured_payload', 'collection_status': 'status_flag', 'posting_status': 'status_flag', 'related_receipt_record': 'relation_collection', 'related_collection_case': 'relation_collection', 'related_journal_entry': 'relation_collection', 'related_sales_order': 'relation_collection', 'related_delivery_note': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'invoice_number', 'customer', 'invoice_date'], 'list_columns': ['title', 'reference_no', 'transaction_date', 'party', 'total_amount', 'workflow_state'], 'initial_state': 'draft', 'lifecycle_states': ['draft', 'approved', 'unpaid', 'partially_paid', 'paid', 'archived'], 'terminal_states': ['paid', 'archived'], 'action_targets': {'create': None, 'update': None, 'review': None, 'approve': 'approved', 'post': None, 'issue': 'unpaid', 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': ['updates AR aging, customer history, cash management, and bookkeeping'], 'related_docs': ['customer_account', 'receipt_record', 'collection_case', 'journal_entry', 'sales_order', 'delivery_note'], 'action_targets': {'create': None, 'update': None, 'review': None, 'approve': 'approved', 'post': None, 'issue': 'unpaid', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
