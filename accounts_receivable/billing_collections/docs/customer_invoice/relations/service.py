"""Relation service seed for customer_invoice."""
...
RELATED_DOCS = [{'doc_id': 'customer_account', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'receipt_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'collection_case', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'journal_entry', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'sales_order', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'delivery_note', 'relation_type': 'related', 'show_in_related_panel': True}]
...
BORROWED_FIELDS = [{'description': 'customer details from customer_account'}, {'description': 'order'}, {'description': 'fulfillment context from sales docs'}]
