"""Action handler seed for customer_invoice:approve."""
...
ACTION_ID = "approve"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['draft', 'approved', 'unpaid', 'partially_paid'], 'transitions_to': 'approved'}
