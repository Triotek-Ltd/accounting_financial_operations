"""Action handler seed for collection_case:close."""
...
ACTION_ID = "close"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['open', 'contacted', 'promised', 'escalated', 'resolved'], 'transitions_to': 'closed'}
