"""Action handler seed for collection_case:resolve."""
...
ACTION_ID = "resolve"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['open', 'contacted', 'promised', 'escalated', 'resolved'], 'transitions_to': 'resolved'}
