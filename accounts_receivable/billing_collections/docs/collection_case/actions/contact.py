"""Action handler seed for collection_case:contact."""
...
ACTION_ID = "contact"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['open', 'contacted', 'promised', 'escalated', 'resolved'], 'transitions_to': None}
...
def handle_contact(payload: dict, context: dict | None = None) -> dict:
    context = context or {}
