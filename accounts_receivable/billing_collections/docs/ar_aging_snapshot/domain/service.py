"""Business-domain service seed for Ar Aging Snapshot."""
...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state', 'posting_date'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'posting_date': 'posting_date', 'as_of_date': 'schedule_marker', 'customer': 'party_reference', 'related_customer_invoice': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'snapshot_code', 'as_of_date', 'customer'], 'list_columns': ['title', 'reference_no', 'posting_date', 'workflow_state'], 'initial_state': 'active', 'lifecycle_states': ['active', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'create': None, 'review': None, 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['customer_invoice', 'customer_account'], 'action_targets': {'create': None, 'review': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
