"""Relation service seed for ar_aging_snapshot."""
...
RELATED_DOCS = [{'doc_id': 'customer_invoice', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'customer_account', 'relation_type': 'related', 'show_in_related_panel': True}]
...
BORROWED_FIELDS = [{'description': 'customer identity from customer_account'}, {'description': 'due balances from customer_invoice'}]
