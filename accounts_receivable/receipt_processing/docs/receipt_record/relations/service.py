"""Relation service seed for receipt_record."""
...
RELATED_DOCS = [{'doc_id': 'customer_invoice', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'cash_account', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'journal_entry', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = [{'field_id': 'customer', 'source_doc_id': 'customer_invoice', 'fetch_profile': 'display_identity', 'fetch_fields': ['title', 'reference_no'], 'purpose': 'party_reference'}]

BORROWED_FIELDS = [{'description': 'customer'}, {'description': 'due balances from customer_invoice or customer_account'}]
