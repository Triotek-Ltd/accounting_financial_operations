"""Relation service seed for cost_center."""
...
DOC_ID = "cost_center"
RELATED_DOCS = [{'doc_id': 'cost_allocation_rule', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'cost_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'variance_record', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'organizational context from management structure docs where applicable'}]
