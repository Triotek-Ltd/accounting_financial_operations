"""Relation service seed for cost_allocation_rule."""
...
RELATED_DOCS = [{'doc_id': 'cost_center', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'cost_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'variance_record', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'cost-center identity from cost_center'}]
