"""Business-domain service seed for Cost Allocation Rule."""
...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'effective_date': 'schedule_marker', 'related_cost_center': 'relation_collection', 'related_cost_record': 'relation_collection', 'related_variance_record': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'rule_code', 'allocation_basis', 'source_pool'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'draft', 'lifecycle_states': ['draft', 'active', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'create': None, 'update': None, 'review': None, 'approve': None, 'archive': 'archived'}}

WORKFLOW_HINTS = {}

SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['cost_center', 'cost_record', 'variance_record'], 'action_targets': {'create': None, 'update': None, 'review': None, 'approve': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
