"""Relation service seed for variance_record."""
...
RELATED_DOCS = [{'doc_id': 'cost_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'cost_center', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'budget_plan', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'targets from budget_plan or standards from cost rules'}]
