"""Relation service seed for ap_aging_snapshot."""
...
RELATED_DOCS = [{'doc_id': 'supplier_invoice', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'supplier_profile', 'relation_type': 'related', 'show_in_related_panel': True}]
...
BORROWED_FIELDS = [{'description': 'supplier identity from supplier_profile'}, {'description': 'outstanding balances from supplier_invoice'}]
