"""Relation service seed for supplier_payment."""
...
RELATED_DOCS = [{'doc_id': 'supplier_invoice', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'payment_request', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'cash_account', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'journal_entry', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = [{'field_id': 'supplier', 'source_doc_id': 'supplier_invoice', 'fetch_profile': 'supplier_profile', 'fetch_fields': ['title', 'reference_no', 'supplier_code', 'email', 'phone', 'contact_email', 'contact_phone'], 'purpose': 'party_reference'}]

BORROWED_FIELDS = [{'description': 'supplier'}, {'description': 'outstanding amount from supplier_invoice'}, {'description': 'execution intent from payment_request'}]
