"""Action handler seed for supplier_invoice:mark_payable."""
...
ACTION_ID = "mark_payable"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['draft', 'approved', 'payable', 'partially_paid'], 'transitions_to': None}
...
def handle_mark_payable(payload: dict, context: dict | None = None) -> dict:
    context = context or {}
