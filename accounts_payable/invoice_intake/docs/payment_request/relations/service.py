"""Relation service seed for payment_request."""
...
RELATED_DOCS = [{'doc_id': 'supplier_invoice', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'supplier_payment', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'cash_account', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'amount'}, {'description': 'due date'}, {'description': 'supplier from supplier_invoice'}]
