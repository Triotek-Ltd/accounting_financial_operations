"""Action handler seed for payment_request:execute."""
...
ACTION_ID = "execute"
ACTION_RULE = {'allowed_in_states': ['draft', 'submitted', 'approved', 'executed', 'cancelled'], 'transitions_to': None}
...
def handle_execute(payload: dict, context: dict | None = None) -> dict:
    context = context or {}
