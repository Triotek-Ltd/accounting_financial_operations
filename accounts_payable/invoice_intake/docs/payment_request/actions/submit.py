"""Action handler seed for payment_request:submit."""
...
ACTION_ID = "submit"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['draft', 'submitted', 'approved', 'executed', 'cancelled'], 'transitions_to': 'submitted'}
